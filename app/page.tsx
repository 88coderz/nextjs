  ...
  return (    
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit text-xl">Serving Our Community &nbsp;
...
*/ }
        ...
        <input placeholder='questions are free !'  className="fixed bottom-0 left-0 flex h-8 w-full items-end justify-center text-center text-lg bg-gradient-to-t from-white via-white dark:from-black dark:via-black" >
